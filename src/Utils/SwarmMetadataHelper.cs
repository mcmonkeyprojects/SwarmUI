...
/// <summary>Helper class to handle encoding and decoding of "stealth" metadata into image pixel data, using LSB steganography. Logic is a C# port of the 'stealth_pnginfo' project's Python implementation.</summary>
