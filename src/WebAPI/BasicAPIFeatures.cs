            ...
            case "comfyui":
                {
                    ...
                    if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    {
                        try
                        {
                            ...
                            {
                                await Utilities.DownloadFile("https://github.com/comfyanonymous/ComfyUI/releases/download/latest/ComfyUI_windows_portable_nvidia_cu124_or_cpu.7z", "dlbackend/comfyui_dl.7z", updateProgress);
                            }
                        }
