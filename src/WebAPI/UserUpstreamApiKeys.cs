...
public static class UserUpstreamApiKeys
{
    ...
    static UserUpstreamApiKeys()
    {
        ...
        Register(new("civitai_api", "civitai", "Civitai", "https://civitai.red/user/account", new("If you plan to use the <a href=\"#\" onclick=\"getRequiredElementById('utilitiestabbutton').click();getRequiredElementById('modeldownloadertabbutton').click();\">Model Downloader</a> utility to download content from <a href=\"https://civitai.red/\" target=\"_blank\" rel=\"noreferrer noopener\">Civitai</a>, you will want to set your Civitai API key below.\n<br>This will allow you to download gated or early-access content that your Civitai account has access to.")));
