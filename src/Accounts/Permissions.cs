...
public static class Permissions
{
    ...
    public static PermInfo InterruptOthers = Register(new("interrupt_others", "Interrupt Others", "Allows an admin to interrupt other user's sessions at wioll..", PermissionDefault.ADMINS, GroupAdmin, PermSafetyLevel.POWERFUL));
