            ...
            if (this.subType == 'VAE') {
                let autoFile = {
                    ...
                    'data': {
                        ...
                        'architecture': 'VAE',
                        'class': 'VAE',
                        'description': 'Use the VAE sepcified in your User Settings, the system default VAE for the selected model class, or the VAE built-in to the selected model',
                ...
                let noneFile = {
                    ...
                    'data': {
                        ...
                        'architecture': 'VAE',
                        'class': 'VAE',
                        'description': 'Use the system default VAE for the selected model class, or the VAE built-in to the selected model',
