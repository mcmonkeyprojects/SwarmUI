...
public static class ComfyUIWebAPI
{
    ...
    {
        if (Program.Backends.AllBackends.TryGetValue(backend, out BackendHandler.AbstractBackendData data) && data.AbstractBackend is ComfyUIAPIAbstractBackend comfyBack)
        {
