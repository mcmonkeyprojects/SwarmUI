...
public class ComfyUIBackendExtension : Extension
{
    ...
    public static Dictionary<string, string> NodeToFeatureMap = new()
    {
        ...
        ["SAM3Grounding"] = "sam3",
        ["SAM3Segment"] = "sam3",
        ["SAM3 Segmentation"] = "sam3",
        ["SAM3 Text Segmentation"] = "sam3",
        ["SAM3VideoSegmentation"] = "sam3",
        ["Sam3VideoSegmentation"] = "sam3",
        ["SAM3_Detect"] = "sam3",
        ["SAM3_TrackToMask"] = "sam3",
        ["SwarmSam3TextSegmentation"] = "sam3_segments",
        ["Sapiens2Loader"] = "sapiens2",
        ["Sapiens2Seg"] = "sapiens2_segments",
        ["Sapiens2SegExtract"] = "sapiens2_segments",
        ["SwarmAnatomyYoloDetection"] = "anatomy_yolo",
        ["SwarmDWPoseRegionDetection"] = "dwpose_regions",
        ["SwarmSegmentMaskPreview"] = "segment_mask_preview",
        ["SwarmSegmentMaskQuality"] = "segment_mask_quality",
        ["SwarmZeroMaskLike"] = "segment_mask_quality",
