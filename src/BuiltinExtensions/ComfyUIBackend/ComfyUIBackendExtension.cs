...
public class ComfyUIBackendExtension : Extension
{
    ...
    public static T2IRegisteredParam<string> WorkflowParam, CustomWorkflowParam, SamplerParam, SchedulerParam, RefinerUpscaleMethod, UseIPAdapterForRevision, IPAdapterWeightType, VideoPreviewType, VideoFrameInterpolationMethod, GligenModel, YoloModelInternal;
    ...
    public static List<string> UpscalerModels = ["pixel-lanczos///Pixel: Lanczos (cheap + high quality)", "pixel-bicubic///Pixel: Bicubic (Basic)", "pixel-area///Pixel: Area", "pixel-bilinear///Pixel: Bilinear", "pixel-nearest-exact///Pixel: Nearest-Exact (Pixel art)", "latent-bislerp///Latent: Bislerp", "latent-bicubic///Latent: Bicubic", "latent-area///Latent: Area", "latent-bilinear///Latent: Bilinear", "latent-nearest-exact///Latent: Nearest-Exact"],
        Samplers = ["euler///Euler", "euler_ancestral///Euler Ancestral", "heun///Heun", "heunpp2///Heun++ 2", "dpm_2///DPM-2 (Diffusion Probabilistic Model)", "dpm_2_ancestral///DPM-2 Ancestral", "lms///LMS (Linear Multi-Step)", "dpm_fast///DPM Fast", "dpm_adaptive///DPM Adaptive (Dynamic Steps)", "dpmpp_2s_ancestral///DPM++ 2S Ancestral (2nd Order Single-Step)", "dpmpp_sde///DPM++ SDE", "dpmpp_sde_gpu///DPM++ SDE, GPU Seeded", "dpmpp_2m///DPM++ 2M (2nd Order Multi-Step)", "dpmpp_2m_sde///DPM++ 2M SDE (Stochastic)", "dpmpp_2m_sde_gpu///DPM++ 2M SDE, GPU Seeded", "dpmpp_3m_sde///DPM++ 3M SDE", "dpmpp_3m_sde_gpu///DPM++ 3M SDE, GPU Seeded", "ddim///DDIM (Denoising Diffusion Implicit Models)", "ddpm///DDPM (Denoising Diffusion Probabilistic Models)", "lcm///LCM (for LCM models)", "uni_pc///UniPC (Unified Predictor-Corrector)", "uni_pc_bh2///UniPC BH2", "euler_cfg_pp///Euler CFG++", "euler_ancestral_cfg_pp///Euler Ancestral CFG++", "ipndm///iPNDM (Improved Pseudo-Numerical methods for Diffusion Models)", "ipndm_v///iPNDM-V (Variable-Step)", "deis///DEIS (Diffusion Exponential Integrator Sampler)"],
