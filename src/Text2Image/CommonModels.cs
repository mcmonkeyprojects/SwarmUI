...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        Register(new("z-image-vae", "Z-Image Turbo VAE", "The VAE for Z-Image Turbo", "https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/vae/ae.safetensors", "afc8e28272cd15db3919bacdb6918ce9c1ed22e96cb12c4d5ed0fba823529e38", "VAE", "ZImage/z_image_vae.safetensors"));
    }
}
