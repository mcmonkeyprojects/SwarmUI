...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        Register(new("z-image-vae", "Z-Image Turbo VAE", "The VAE for Z-Image Turbo", "https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/vae/ae.safetensors", "ae3b6507425a8f9361a457199435a2d04261730075d943265842866299d638a1", "VAE", "ZImage/z_image_vae.safetensors"));
    }
}
