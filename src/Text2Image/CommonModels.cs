...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        Register(new("minimax-h3-video-vae", "MiniMax H3 Video VAE", "The video VAE for MiniMax H3.", "https://huggingface.co/Comfy-Org/MiniMax-H3/resolve/main/vae/minimax_h3_video_vae_fp16.safetensors", "5b86f3fb5dc7c87949426a9262ebda3d95f4d414f8075afb895b321cadc617a9", "VAE", "MiniMaxH3/minimax_h3_video_vae_fp16.safetensors"));
        ...
        Register(new("minimax-h3-audio-vae", "MiniMax H3 Audio VAE", "The audio VAE for MiniMax H3.", "https://huggingface.co/Comfy-Org/MiniMax-H3/resolve/main/vae/minimax_h3_audio_vae_fp32.safetensors", "d132ce0297fda95139762b689c22de3507581b897c03f766964a9edfee8c8d3c", "VAE", "MiniMaxH3/minimax_h3_audio_vae_fp32.safetensors"));
    }
}
