...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        Register(new("flux2-ae", "Flux.2-AE", "The AE for Flux.2", "https://huggingface.co/Comfy-Org/flux2-dev/resolve/main/split_files/vae/flux2-vae.safetensors", "d64f3a68e1cc4f9f4e29b6e0da38a0204fe9a49f2d4053f0ec1fa1ca02f9c4b5", "VAE", "Flux/flux2-vae.safetensors"));
