...
public class T2IParamTypes
{
    ...
    public static void RegisterDefaults()
    {
        ...
        FluxGuidanceScale = Register<double>(new("Flux Guidance Scale", "What guidance scale to use for Flux-Dev, Flux2-Dev, or related models.\nDoes not apply to Flux-Schnell.\nFor Flux-Dev and Flux2-Dev, this is a distilled embedded value the model was trained on, this is based on an alternative guidance methodology, and is not CFG.\n3.5 is default, but closer to 2.0 may allow for more stylistic flexibility.\nFor Hunyuan Video, this is distilled from CFG Scale, and prefers values closer to 6.",
