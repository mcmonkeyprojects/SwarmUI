...
public class T2IParamTypes
{
    ...
    public static void RegisterDefaults()
    {
        ...
        static bool isVideoClass(string id) => id.Contains("stable-video-diffusion") || id.Contains("lightricks-ltx-video") || id.Contains("-video2world");
